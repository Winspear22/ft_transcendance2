<template>
  ...
  export default {
    ...
    beforeDestroy() {
      this.socketChat.off('demoteAdmin', this.handleDemoteResponse);
    ...
    methods: {
      ...
      demoteUserFromAdmin() {
        ...
        this.isError = false;
        this.socketChat.emit('demoteAdmin', {
            channelName: this.channelName,
      ...
      handleDemoteResponse(data) {
          if (typeof data === "string" && data.includes("Error")) {
              ...
              this.adminMessage = "L'utilisateur a été rétrogradé avec succès.";
              this.isError = false;
          } else {
