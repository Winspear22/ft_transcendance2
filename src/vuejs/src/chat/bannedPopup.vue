...
mounted() {
  ...
  this.socketChat.on('demotedAdmin', this.handleBanned);
  this.socketChat.on('promotedAdmin', this.handleBanned);
...
beforeDestroy() {
  ...
  this.socketChat.off('deomotedAdmin', this.handleBanned);
  this.socketChat.off('promotedAdmin', this.handleBanned);
